...
- **Calendar e a integração com Google Calendar.** A área de agenda, suas APIs, sincronização,
  ferramentas MCP e configuração OAuth foram removidas do produto. Os dados já existentes no
  banco são preservados nesta atualização.
